...
export const parseGeometry = (
  ...
  switch (type) {
    case GeometryType.Point:
      return {
        type: "Point",
        coordinates: readPoint(dataView, littleEndian, offset),
      };
    case GeometryType.LineString:
      return {
        type: "LineString",
        coordinates: readLineString(dataView, littleEndian, offset),
      };
    case GeometryType.Polygon:
      return {
        type: "Polygon",
        coordinates: readPolygon(dataView, littleEndian, offset),
      };
